...
For how the Staking and Interest contracts work (owner powers and limits), see the [Contract explanation](/guide/staking-contracts/). For contract addresses, APR meaning, and full risk language, see the [Terms & Risk Disclosure](/terms).
