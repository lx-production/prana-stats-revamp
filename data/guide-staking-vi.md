...
Cơ chế hai hợp đồng Staking / Interest (quyền và giới hạn của owner): xem [Giải thích Hợp đồng](/guide/staking-contracts/). Về địa chỉ contract, ý nghĩa APR, và toàn bộ ngôn ngữ rủi ro, xem [Điều khoản & Công bố rủi ro](/terms).
