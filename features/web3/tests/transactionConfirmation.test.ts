...
/**
 * Characterization tests for browser-receipt → server-fallback confirmation.
 * Shared by Staking and Bonding thin adapters.
 */
...
test('confirms from the browser receipt without calling the server', async () => {
  ...
  const outcome = await confirmBroadcastTransaction({
