...
export function sanitizeStakingErrorMessage(
  ...
  const allowedMessages = [
    ...
    'Invalid staking transaction hash.',
    'Invalid staking confirmation account.',
    'Invalid staking confirmation action.',
    'Invalid staking stake amount.',
    'Invalid staking stake duration.',
    'Invalid staking stake deadline.',
    'Invalid staking stake signature v.',
    'Invalid staking stake signature r.',
    'Invalid staking stake signature s.',
